...
call adams2023_3 python %MSC_PY_TOOLS%\xml_res_reader_ucf.py %CD%\1a_script.txt
call adams2023_3 python %MSC_PY_TOOLS%\xml_res_reader_ucf.py %CD%\1b_script.txt
