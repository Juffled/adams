...
call adams2023_3 python %MSC_PY_TOOLS%\xml_res_reader_ucf.py %CD%\AD035_script.txt
call adams2023_3 python %MSC_PY_TOOLS%\xml_res_reader_ucf.py %CD%\AD036_script.txt
